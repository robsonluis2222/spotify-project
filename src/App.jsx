    ...
    <div className='container'>
      <div className='app'>
        ...
        <div className='mais-ouvidas'>
          <span>Artistas populares #3</span>
        ...
        <div className='cont2'>
          ...
          <div className='faixas'>
            <Faixa img="https://i.scdn.co/image/ab67616d00001e02535c1a6270af5430a2c90b07" musicName="Modo Esquece" artist="MC Menor da VG e Mc IG" />
            <Faixa img="https://i1.sndcdn.com/artworks-H8e0qiHqDlb2zn0W-ftzQhw-t500x500.jpg" musicName="SET DO BUZEIRA" artist="MC Marks e Mc Bruninho da Praia" />
            <Faixa img="https://i.scdn.co/image/ab67616d0000b27364edffc1d6b3c59761f87963" musicName="Filha do Jornalista" artist="MC IG" />
            <Faixa img="https://i1.sndcdn.com/artworks-wEozMCM6oFHRVlA9-Ksj7Ug-t500x500.jpg" musicName="Set Wesley Alemão 2" artist="MC Paulin da Capital e Mc Kadu" />
          </div>
        </div>
      </div>
    </div>
